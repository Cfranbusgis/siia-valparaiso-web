...
7. **Exposición compuesta recalibrada** (`prep_dem30.py`, `topo_30m.py`,
   `exposicion_v2.py`): componente meteorológica desde el percentil empírico
   corregido y topográfica desde el TWI derivado del modelo de superficie
   ALOS AW3D30 a 30 m (resolución acorde al tamaño de los humedales; carácter
   DSM declarado), sobre el conjunto ≥ P90; la ponderación se somete a
   análisis de sensibilidad (30/70–70/30) y se reporta el núcleo robusto de
   172 humedales invariante a ella.
