...
STEPS = [
    ...
    ("fetch_recent.py", "Precipitación reciente 1 jul-19 jul 03:00 (Open-Meteo)", False),
    ("extend_clim_19.py", "Extiende la climatología homogénea a 1-19 jul", False),
    ("patch_grid_recent.py", "Propaga el reciente a la grilla (ventana nueva)", False),
